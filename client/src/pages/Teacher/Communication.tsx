        ...
        <DashboardLayout role="teacher">
            <div className="h-[calc(100vh-100px)] flex flex-col gap-6">
                <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400">Manage meeting requests and chat with parents.</p>
                </div>

                <div className="flex gap-4 border-b border-slate-200 dark:border-slate-800 pb-1">
                    <button
                        onClick={() => setActiveTab('requests')}
                        className={`pb-3 px-4 text-sm font-bold transition-all border-b-2 ${activeTab === 'requests' ? 'border-purple-500 text-purple-400' : 'border-transparent text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white'}`}
                    >
                        Meeting Requests
                        {requests.filter(r => r.status === 'pending').length > 0 && (
                            <span className="ml-2 bg-purple-500 text-slate-900 dark:text-white text-[10px] px-1.5 py-0.5 rounded-full">
                    ...
                    <button
                        ...
                        className={`pb-3 px-4 text-sm font-bold transition-all border-b-2 ${activeTab === 'chat' ? 'border-purple-500 text-purple-400' : 'border-transparent text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white'}`}
                    >
                        Chat
                    </button>
                </div>
                ...
                {activeTab === 'requests' ? (
                    <div className="grid gap-4">
                        {requests.length === 0 ? (
                            <div className="p-8 text-center text-slate-500 border border-slate-200 dark:border-slate-800 rounded-xl border-dashed">
                            ...
                            requests.map((req) => (
                                <div
                                    ...
                                    className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-6 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 hover:border-blue-500/50 cursor-pointer transition-all group"
                                >
                                    <div className="flex-1">
                                        ...
                                        <h3 className="font-bold text-slate-900 dark:text-white text-lg group-hover:text-blue-400 transition-colors">{req.reason}</h3>
                                        <p className="text-slate-600 dark:text-slate-400 text-sm mt-1">
                                            With <span className="text-slate-900 dark:text-white font-medium">{req.parentName}</span> (Parent of {req.studentName})
                                        </p>
                                    ...
                                    {req.status === 'pending' && (
                                        <div className="flex items-center gap-3 self-end md:self-center" onClick={(e) => e.stopPropagation()}>
                                            <button
                                                ...
                                                className="p-3 rounded-xl bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:text-red-400 hover:border-red-500/50 hover:bg-red-500/10 transition-all group"
                                            ...
                                            <button
                                                ...
                                                className="flex items-center gap-2 px-6 py-3 rounded-xl bg-gradient-to-r from-purple-600 to-pink-600 text-slate-900 dark:text-white font-bold hover:opacity-90 transition-opacity shadow-[0_0_20px_rgba(168,85,247,0.3)]"
                                            >
                                                <Check size={18} />
                                                Approve Meeting
                                            </button>
                    ...
                    <div className="flex-1 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl flex flex-col overflow-hidden">
                        <div className="p-4 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 flex items-center justify-between">
                            <div className="flex items-center gap-3">
                                <div className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center text-slate-900 dark:text-white font-bold">
                                    MV
                                </div>
                                <div>
                                    <h3 className="font-bold text-slate-900 dark:text-white">Mr. Verma</h3>
                                    <p className="text-xs text-slate-600 dark:text-slate-400">Parent of Arjun</p>
                                </div>
                            </div>
                        </div>
            ...
            {selectedRequest && (
                <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-8 max-w-lg w-full shadow-2xl animate-in fade-in zoom-in duration-300">
                        <div className="flex justify-between items-start mb-6">
                            <div>
                                <h2 className="text-2xl font-bold text-slate-900 dark:text-white mb-1">Meeting Details</h2>
                                <p className="text-slate-600 dark:text-slate-400 text-sm">Request ID: #{selectedRequest.id}</p>
                            </div>
                            <button
                        ...
                        <div className="space-y-6">
                            <div className="bg-slate-50 dark:bg-slate-950 p-4 rounded-xl border border-slate-200 dark:border-slate-800">
                                ...
                                <p className="text-lg font-medium text-slate-900 dark:text-white">{selectedRequest.reason}</p>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div className="bg-slate-50 dark:bg-slate-950 p-4 rounded-xl border border-slate-200 dark:border-slate-800">
                                    ...
                                    <p className="font-medium text-slate-900 dark:text-white">{selectedRequest.date}</p>
                                </div>
                                <div className="bg-slate-50 dark:bg-slate-950 p-4 rounded-xl border border-slate-200 dark:border-slate-800">
                                    <div className="flex items-center gap-2 mb-1">
                                        <Clock size={14} className="text-purple-400" />
                                    ...
                                    <p className="font-medium text-slate-900 dark:text-white">{selectedRequest.time}</p>
                                </div>
                            </div>
                            ...
                            <div className="bg-slate-50 dark:bg-slate-950 p-4 rounded-xl border border-slate-200 dark:border-slate-800">
                                ...
                                <div className="space-y-3">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="text-slate-900 dark:text-white font-medium">{selectedRequest.parentName}</div>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div className="text-slate-900 dark:text-white font-medium">{selectedRequest.studentName}</div>
                            ...
                            <div className="bg-slate-50 dark:bg-slate-950 p-4 rounded-xl border border-slate-200 dark:border-slate-800 flex justify-between items-center">
                                <div>
                                    ...
                                    <p className="text-slate-900 dark:text-white font-medium">Room 302, Main Block</p>
                                </div>
                            ...
                            <div className="flex gap-3 pt-2">
                                <button
                                    onClick={() => setSelectedRequest(null)}
                                    className="flex-1 py-3 bg-slate-50 dark:bg-slate-800 hover:bg-slate-100 dark:bg-slate-700 text-slate-900 dark:text-white rounded-xl font-medium transition-colors"
                                >
                                    Close
                                </button>
                                {selectedRequest.status === 'pending' && (
                                    <button
                                        ...
                                        className="flex-1 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:opacity-90 text-slate-900 dark:text-white rounded-xl font-bold transition-opacity"
                                    >
                                        Approve
                                    </button>
                                )}
