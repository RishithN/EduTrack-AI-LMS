        ...
        <DashboardLayout role="parent">
            <div className="space-y-8">
                <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400">Detailed breakdown of Arjun's grades and skills.</p>
                </div>

                <div className="grid md:grid-cols-3 gap-6">
                    {/* GPA Card */}
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl md:col-span-1">
                        <h3 className="text-slate-600 dark:text-slate-400 font-bold uppercase tracking-wider text-sm mb-4">Overall CGPA</h3>
                        <div className="flex items-end gap-2">
                            <span className="text-5xl font-extrabold text-slate-900 dark:text-white">9.2</span>
                        ...
                        <div className="mt-6 flex flex-col gap-2">
                            <div className="flex justify-between text-sm">
                                ...
                                <span className="text-slate-900 dark:text-white font-bold">8.9</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span className="text-slate-600 dark:text-slate-400">Semester 2</span>
                                <span className="text-slate-900 dark:text-white font-bold">9.0</span>
                            </div>
                            <div className="flex justify-between text-sm">
                                <span className="text-slate-600 dark:text-slate-400">Semester 3</span>
                    ...
                    {/* Skills Graph (Visual) */}
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-2xl md:col-span-2">
                        <h3 className="text-slate-600 dark:text-slate-400 font-bold uppercase tracking-wider text-sm mb-6">Skill Proficiency</h3>
                        <div className="space-y-4">
                            {SKILLS.map((skill) => (
                                <div key={skill.name}>
                                    ...
                                    <div className="h-2 bg-slate-50 dark:bg-slate-950 rounded-full overflow-hidden">
                                        <div
                ...
                <div className="flex gap-4 border-b border-slate-200 dark:border-slate-800 pb-1">
                    <button
                        ...
                        className={`pb-3 px-2 text-sm font-medium transition-colors relative ${activeTab === 'exams' ? 'text-purple-400' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white'}`}
                    >
                        Exam Reports
                    ...
                    <button
                        ...
                        className={`pb-3 px-2 text-sm font-medium transition-colors relative ${activeTab === 'quizzes' ? 'text-purple-400' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white'}`}
                    >
                        Quiz Performance
                    ...
                    <button
                        ...
                        className={`pb-3 px-2 text-sm font-medium transition-colors relative ${activeTab === 'labs' ? 'text-purple-400' : 'text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:text-white'}`}
                    >
                        Lab Performance
                    ...
                    {activeTab === 'exams' && (
                        <>
                            <div className="p-4 border-b border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-950 flex justify-between items-center">
                                ...
                                <span className="text-xs font-mono text-slate-500 bg-white dark:bg-slate-900 px-2 py-1 rounded border border-slate-200 dark:border-slate-800">
                                    FALL 2024
                                </span>
                            </div>
                        ...
                        <div className="p-6">
                            <div className="grid gap-4">
                                {QUIZ_RESULTS.map((quiz, idx) => (
                                    <div key={idx} className="flex items-center justify-between bg-slate-950/50 border border-slate-200 dark:border-slate-800 p-4 rounded-xl">
                                        <div className="flex items-center gap-4">
                                            <div className="p-3 bg-purple-500/10 text-purple-400 rounded-lg">
                                                <Trophy size={20} />
                                            </div>
                                            <div>
                                                <h4 className="font-bold text-slate-900 dark:text-white">{quiz.topic}</h4>
                                                <p className="text-sm text-slate-500">{quiz.date}</p>
                                            </div>
                                        </div>
                                        <div className="text-right">
                                            <div className="text-xl font-bold text-slate-900 dark:text-white">{quiz.score}/{quiz.total}</div>
                                ...
                                {LAB_RESULTS.map((lab, idx) => (
                                    <div key={idx} className="flex items-center justify-between bg-slate-950/50 border border-slate-200 dark:border-slate-800 p-4 rounded-xl">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div>
                                                <h4 className="font-bold text-slate-900 dark:text-white">{lab.subject}</h4>
                                        ...
                                        <div className="flex items-center gap-4">
                                            ...
                                            <div className="w-10 h-10 rounded-full bg-slate-50 dark:bg-slate-800 flex items-center justify-center font-bold text-slate-900 dark:text-white border border-slate-300 dark:border-slate-700">
                                                {lab.grade}
                                            </div>
                                        </div>
                                    </div>
