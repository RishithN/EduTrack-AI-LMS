        ...
        <DashboardLayout role="student">
            <div className="space-y-8">
                <div>
                    ...
                    <p className="text-slate-600 dark:text-slate-400">Important dates and schedules for the semester.</p>
                </div>
                ...
                <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="lg:col-span-2 space-y-4">
                        {ACADEMIC_EVENTS.map((event, idx) => (
                            <div key={idx} className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl flex items-center gap-6 group hover:border-purple-500/30 transition-all">
                                ...
                                <div className="flex-1">
                                    <div className="flex justify-between items-start">
                                        <div>
                                            <h3 className={`text-lg font-bold ${event.status === 'Completed' ? 'text-slate-500 line-through' : 'text-slate-900 dark:text-white'}`}>
                                                {event.title}
                                            </h3>
                    ...
                    {/* Summary Card */}
                    <div className="bg-gradient-to-br from-purple-900/20 to-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl p-6 h-fit">
                        <h3 className="font-bold text-slate-900 dark:text-white mb-4">Semester Summary</h3>
                        <div className="space-y-6">
                            <div>
                                <div className="text-slate-600 dark:text-slate-400 text-sm mb-1">Current Semester</div>
                                <div className="text-2xl font-bold text-slate-900 dark:text-white">Fall 2026</div>
                            </div>
                            <div className="flex gap-4">
                                <div>
                                    <div className="text-slate-600 dark:text-slate-400 text-sm mb-1">Working Days</div>
                                    <div className="text-xl font-bold text-slate-900 dark:text-white">90</div>
                                </div>
                                <div>
                                    <div className="text-slate-600 dark:text-slate-400 text-sm mb-1">Holidays</div>
                            ...
                            <div className="pt-6 border-t border-slate-200 dark:border-slate-800/50">
                                ...
                                <div className="pl-7 font-mono text-slate-600 dark:text-slate-400 text-sm">09:00 AM - 04:00 PM</div>
                            </div>
                        </div>
                    </div>
                </div>
