        ...
        <DashboardLayout role="student">
            <div className="space-y-6">
                <div>
                    ...
                    <p className="text-slate-400">Current semester enrolled courses</p>
                </div>
                        ...
                        <div className="bg-slate-900 border border-slate-800 rounded-2xl p-8 max-w-2xl w-full">
                            <div className="flex justify-between items-start mb-6">
                                <div className="flex-1">
                                    ...
                                    <p className="text-slate-400">{selectedCourse.instructor}</p>
                                </div>
                            ...
                            <div className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div className="bg-slate-950 p-4 rounded-lg border border-slate-800">
                                        ...
                                        <div className="text-2xl font-bold text-white">{selectedCourse.credits}</div>
                                    </div>
                                    <div className="bg-slate-950 p-4 rounded-lg border border-slate-800">
                                        <div className="text-slate-400 text-sm mb-1">Schedule</div>
                                        <div className="text-sm font-medium text-white">{selectedCourse.schedule}</div>
                                    </div>
                                </div>
